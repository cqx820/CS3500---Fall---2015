...
namespace ModelTester
{
    ...
    /// </summary>
    /// Author: Qixiang Chao and Yiliang Shi
    [TestClass]
    public class WorldTester
    {
        ...
        public void addCubeTest1()
        {
            ...
            Assert.AreEqual(cube, world.foodCubes[5571]);
        }
        ...
        public void addCubeTest2()
        {
            ...
            Assert.AreEqual(cube2, world.foodCubes[36]);
        }
        ...
        public void addCubeTest4()
        {
            ...
            Assert.AreEqual(cube2, world.foodCubes[1]);
            Assert.AreEqual(cube3, world.foodCubes[2]);
            Assert.AreEqual(cube4, world.foodCubes[3]);
            Assert.AreEqual(cube5, world.foodCubes[4]);
            Assert.AreEqual(cube6, world.foodCubes[5]);
            Assert.AreEqual(cube7, world.foodCubes[6]);
            Assert.AreEqual(cube8, world.foodCubes[7]);
            Assert.AreEqual(cube9, world.foodCubes[8]);
            Assert.AreEqual(cube10, world.foodCubes[9]);
            Assert.AreEqual(cube11, world.foodCubes[10]);
        }
        ...
        public void getUidsTest()
        {
            ...
            world.addCube(9, cube10);
            world.addCube(10, cube11);
            Assert.AreEqual(world.foodCubes.Keys, world.getUids());
        }
